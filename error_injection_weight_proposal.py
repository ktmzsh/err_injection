...
output_proposal = 'hist_adj_weights'
...
def main():
    ...
    for current_weight_num in range(8):  # 0:conv1, ... , 7:deconv4
        for pe_cycle in range(1):  # 0:pe1,...,20:pe800K
            ...
            for i in range(parameter_num):
                if (random.random() > ARR_total_BER[pe_cycle]):
                    ...
                    """if -0.4 <= float_temp <= -0.3:
                        float_temp = -0.35
                    elif -0.3 <= float_temp <= -0.2:
                        float_temp = -0.25
                    elif -0.2 <= float_temp <= -0.1:
                        float_temp = -0.15
                    elif -0.1 <= float_temp <= -0.0875:
                        float_temp = -0.0925
                    elif -0.0875 <= float_temp <= -0.075:
                        float_temp = -0.08125
                    elif -0.075 <= float_temp <= -0.0625:
                        float_temp = -0.06875
                    elif -0.0625 <= float_temp <= -0.05:
                        float_temp = -0.05625
                    elif -0.05 <= float_temp <= -0.0375:
                        float_temp = -0.04375
                    elif -0.0375 <= float_temp <= -0.025:
                        float_temp = -0.03125
                    elif -0.025 <= float_temp <= -0.0125:
                        float_temp = -0.01875
                    elif -0.0125 <= float_temp <= 0:
                        float_temp = -0.00625
                    elif 0 <= float_temp <= 0.1:
                        float_temp = 0.05
                    elif 0.1 <= float_temp <= 0.2:
                        float_temp = 0.15
                    elif 0.2 <= float_temp <= 0.3:
                        float_temp = 0.25
                    elif 0.3 <= float_temp <= 0.4:
                        float_temp = 0.35
                    else:
                        float_temp = 0"""
                    arr[i] = float_temp
            ...
            output_name = os.path.join(output_proposal,
                                       weight_name_list[current_weight_num] + extention_csv)
